...
translations.lang["zh"] = {
    ...
    ---["Adding translations for language "] = "正在添加语言翻译 ",
    ---["Found label for "] = "建立标签 ",
    ---["Registered "] = "记录 ",
    ---["Saving translation for "] = "正在保存翻译 ",
    ---["Could not natives lib. Make sure it is selected under Stand > Lua Scripts > Repository > natives-1663599433"] = "无法使用本机依赖库.确保该依赖项已正确安装 Stand > Lua Scripts > 仓库 > natives-1663599433",
    ---["Max table depth reached"] = "达到最大组合数量？",
    ["Adding attachment to construct "] = "正在向构造添加附件 ",
    ["Removing preview "] = "正在删除预览(debug) ",
    ---["Adding a preview "] = "正在添加预览",
    ["Building construct plan description "] = "正在创建构造方案说明",
    ---["Adding preview for construct plan "] = "正在为构造方案添加预览 ",
    ...
    ["Animating peds "] = "可活动的行人 ",
    ["Rebuilding ped "] = "正在重建行人 ",
    ...
    ["Ped Options"] = "行人选项",
    ["Can Rag Doll"] = "允许布娃娃",
    ["If enabled, the ped can go limp."] = "如果启用,行人将可以跌倒.",
    ["Armor"] = "护甲",
    ["How much armor does the ped have."] = "行人有多少护甲",
    ["On Fire"] = "着火",
    ...
    ["Copy to Me"] = "复制到我",
    ["Attach a copy of this object to your Ped."] = "复制并附加此物体到你身上.",
