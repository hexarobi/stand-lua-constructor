...
translations.lang["zh"] = {
    ...
    ["Select gizmo arrow"] = "按住旋转视角",
    ["Hold to spin camera"] = "箭头点击物体",
    ["Edit Modes"] = "编辑模式",
    ["Gizmo Edit"] = "箭头编辑",
    ...
    ["Any free seat"] = "副驾驶",
    ["Passenger"] = "乘客",
    ["Backseat Driver Side"] = "驾驶后排",
    ["Backseat Passenger Side"] = "乘客后排",
    ["Head Overlays"] = "头部覆盖",
    ["Eye Color"] = "眼睛颜色",
    ["Configure animation options"] = "配置动画选项",
    ["Current"] = "当前动画",
    ["Refresh Timer"] = "动画刷新时间",
    ["How often should the animation be totally reset. 0 means never."] = "动画刷新频率是多少.0等于循环播放",
    ["Immediately stops the current animation"] = "停止当前动画",
    ["Browse Animations"] = "浏览动画",
    ["Set by Name"] = "名称设置",
    ["Set a specific animation dictionary+clip or scenario"] = "设置特定的场景或剪辑动画",
    ["Dictionary and Clip"] = "场景或剪辑",
    ["Set the animation dictionary and clip (separated by a space)."] = "场景或剪辑动画(用空格分开).",
    ["Dictionary and Clip List"] = "场景或剪辑列表",
...
translations.lang["fr"] = {
    ...
    ["Rebuilding attachment menu "] = "Recréation du menu de joints ",
    ["Name"] = "Nom",
